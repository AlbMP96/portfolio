...
export default function Home() {
    ...
    return (
        <div className="items-center justify-items-center h-screen font-[family-name:var(--font-geist-sans)] overflow-y-scroll snap-y snap-mandatory">
            ...
            <div
                id="banner"
                className="h-screen relative snap-always snap-center"
            >
            ...
            <div id="about" className="snap-always snap-center h-screen">
                <div className="flex flex-row items-center justify-center h-full">
                    <div className="basis-2/3 p-10">
                        <div>
                            <h1 className="text-5xl mb-3">Sobre mi</h1>
                            <p>
                                Soy una persona con gran curiosidad, siempre
                                estoy buscando nuevas cosas que aprender e
                                intentando aprender lo máximo de las
                                experiencias con las que me encuentro. Tambien
                                que gustan los retos para conseguir superarlos y
                                asi sacar nuevas cosas que aprender.
                            </p>
                            <p>
                                He estudiado los ciclos de Desarrollo de
                                Aplicaciones Multiplataforma y Desarrollo de
                                Aplicaciones Web, por que lo que tengo una base
                                amplia en la programación, durante ese tiempo he
                                utilizado diversas tecnologías como Java, SQL,
                            ...
                            <p>
                                Para la mayoría de proyectos que he hecho a lo
                                largo de este tiempo he utilizado también Git,
                                para llevar un mejor control del desarrollo de
                                las aplicaciones durante mi trabajo en ellas.
                            </p>
                        </div>
                        <div className="flex flex-row mt-5">
                            ...
                            >
                                <a
                                    href="https://www.linkedin.com/in/alberto-mu%C3%B1iz-p%C3%A1ramo/"
                                    target="_blank"
                                >
                                    <path
                                        fill="#0288D1"
                            ...
                            <InteractiveHoverButton>
                                <a
                                    href="https://drive.google.com/file/d/1fiPhyO_8YclIS2nft9I-xjHz1Dzewree/view?usp=sharing"
                                    target="_blank"
                                >
                                    CV Completo
                                </a>
